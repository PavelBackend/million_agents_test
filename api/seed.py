...
async def seed() -> None:
    ...
    async with session_factory() as session:
        ...
        """
            ...
            {"p1": proj1_id, "p2": proj2_id, "alice_id": alice_id, "bob_id": bob_id, "carol_id": carol_id},
        )
        ...
        history = [
            dict(
                task_id=uuid.UUID("00000000-0000-0000-0002-000000000002"),
                changed_by=alice_id,
                from_status="created",
            ...
            dict(
                task_id=uuid.UUID("00000000-0000-0000-0002-000000000001"),
                changed_by=alice_id,
                from_status="created",
                to_status="in_progress",
                comment="Starting",
            ...
            dict(
                task_id=uuid.UUID("00000000-0000-0000-0002-000000000004"),
                changed_by=bob_id,
                from_status="created",
                to_status="in_progress",
                comment=None,
            ...
            dict(
                task_id=uuid.UUID("00000000-0000-0000-0002-000000000006"),
                changed_by=bob_id,
                from_status="created",
                to_status="cancelled",
